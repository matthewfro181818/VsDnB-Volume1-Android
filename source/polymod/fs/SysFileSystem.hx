...
class SysFileSystem implements IFileSystem
{
	...
	{
		return sys.FileSystem.exists(SUtil.getStorageDirectory() + path);
	}

	public function isDirectory(path:String)
	{
		return sys.FileSystem.isDirectory(SUtil.getStorageDirectory() + path);
	}
	...
	public function readDirectory(path:String):Array<String>
	{
		try
		{
			return sys.FileSystem.readDirectory(SUtil.getStorageDirectory() + path);
		}
		catch (e)
		{
